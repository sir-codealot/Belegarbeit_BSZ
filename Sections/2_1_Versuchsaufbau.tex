\subsubsection{Installieren und Konfigurieren der Software auf den WS}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_1/02.PNG}
        \source{Instellation mit XAMPP Wizard}{Screenshot}{}
    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_1/03.PNG}
        \source{Instellationsverzeichnis}{}{}
    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_1/06_Auswahl.png}
...
\subsubsection{Netzwerkfunktionalität beider Workstations}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_2/1.png}
        \source{Ping von Workstation 2 zu Workstation 1}{Screenshot}{}
    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_2/2.png}
...
\subsubsection{Netzwerkfunktionalität beider Workstations}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_3/1.png}
        \source{hallo.htm nach C:{\textbackslash}xampp{\textbackslash}htdocs kopieren}{Screenshot}{}
    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_3/2.png}
        \source{Apache in XAMPP Starten}{Screenshot}{}
    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_3/4.png}
        \source{lokaler Aufruf von hallo.htm}{}{}
    \end{figure}

    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_3/5.png}
        \source{Aufruf von hallo.htm per IP}{}{}
    \end{figure}

\subsubsection{Installieren von Wireshark}
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{2_1_4/01.PNG}
